import React, { useState, ReactNode, useEffect } from 'react'; // 1. Import useEffect
import { Route, Routes, useLocation } from 'react-router-dom'; // 2. Import useLocation
...
const App: React.FC = () => {
  // 3. Get the current pathname using useLocation
  const { pathname } = useLocation();

  // 4. Add the useEffect hook to scroll to top on pathname change
  useEffect(() => {
    window.scrollTo(0, 0);
  }, [pathname]);
